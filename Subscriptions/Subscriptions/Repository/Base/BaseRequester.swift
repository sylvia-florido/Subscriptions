...
class BaseRequester: NSObject {
    ...
    // Test : Added this as an example if there were more parameters to add to service queries
    private func urlFromParameters(_ parameters: [String:AnyObject]?, pathExtension: String? = nil) -> URL? {
        var components = URLComponents()
//        components.scheme = SubscriptionsService.Constants.ApiScheme
//        components.host = SubscriptionsService.Constants.ApiHost
//        components.path = SubscriptionsService.Constants.ApiPath + (pathExtension ?? "")
    ...
    // Test : Added this as an example for images download
